...
static const char *mutevol[] = { "/home/mearnic/work/bash/core/vol-toggle.sh", NULL };
...
static Key keys[] = {
   ...
   { Mod1Mask|ControlMask,           XK_Down,    spawn,    {.v = downvol } },
   { Mod1Mask|ControlMask,           XK_Return,  spawn,    {.v = mutevol } },
   ...
   { Mod1Mask,                       XK_grave,  focusmon,       {.i = -1 } },
   //{ Mod1Mask,                     XK_period, focusmon,       {.i = +1 } },
   { Mod1Mask|ShiftMask,             XK_grave,  tagmon,         {.i = -1 } },
   //{ Mod1Mask|ShiftMask,           XK_period, tagmon,         {.i = +1 } },

   { ShiftMask,                    XK_Return,  togglescratch,  {.v = scratchpadcmd } },
